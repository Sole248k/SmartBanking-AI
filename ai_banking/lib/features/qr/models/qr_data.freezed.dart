...
class _$QrDataImpl implements _QrData {
  ...
  @override
  String toString() {
    return 'QrData(recipientId: $recipientId, recipientName: $recipientName, accountNumber: $accountNumber, amount: $amount, note: $note)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, recipientId, recipientName, accountNumber, amount, note);
...
abstract class _QrData implements QrData {
  const factory _QrData(
      ...
      final double? amount,
      final String? note}) = _$QrDataImpl;
